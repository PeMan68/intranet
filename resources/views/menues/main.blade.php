...
<navigation-link url="http://172.16.0.184/quarta/q3/home/QPAP/en"><slot>QUARTA</slot></navigation-link>
...
@endshowmodule
@hasrole('support')
<a href="{{ route('support.importproducts')}}">Uppdatera produkter</a>
<a href="{{ route('support.importreplacementproducts')}}">Uppdatera ersättningsprodukter</a>
@endhasrole
@hasrole('admin')
<span class="border-top mt-1"></span>
