...
class NotifyFollowersOfPaused
{
    ...
    public function handle(IssuePaused $event)
    {
        ...
        foreach ($followers as $follower) {
            ...
            Log::channel('templog')->debug('SendEmailToFollowersAboutReminder dispathed: '. $event->issue->ticketNumber . ' to ' . $follower->email . '. typeOfReminder: ' . $event->typeOfReminder .'. Delay: ' . $delay);
        }
